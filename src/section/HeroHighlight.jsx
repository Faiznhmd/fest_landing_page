    ...
    <div className="flex flex-col lg:flex-row items-center gap-10 h-full lg:h-[100vh] mt-[100px] lg:mt-0">
      <div>
        ...
        >
          ...
          is here with its annual tech fest Tech Udbhav to discover the magic of
          science, with a magical chip equipped in our skull and spells learnt,
          tried and tasted by time.
        </motion.h1>
      </div>
      <motion.div
        initial={{
